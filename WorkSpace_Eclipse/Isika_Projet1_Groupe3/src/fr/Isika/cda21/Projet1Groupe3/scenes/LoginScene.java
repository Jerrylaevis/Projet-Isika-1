...
public class LoginScene extends Scene {
	...
	public LoginScene(Stage stage, AbrBinaire arbre,RandomAccessFile raf) {
		...
		espaceAdmin.setPadding(new Insets(-10,0,0,65));
		espaceAdmin.setFont(Font.font("Century Gothic",FontWeight.BOLD,14));
		id = new PersoLabel("Identifiant : ");
		id.setPadding(new Insets(5,30,0,10));
		textId = new PersoTextField();
		textId.setPromptText("Votre identifiant");
		mdp = new PersoLabel("Mot de passe : ");
		textMdp = new PasswordField();
			textMdp.setFont(Font.font("Century Gothic",12));
		...
		ligne1.setPadding(new Insets(0,0,50,-50));
